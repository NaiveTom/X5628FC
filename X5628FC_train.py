...
val_generator = train_datagen.flow_from_directory(directory = './train/', # same directory as training data
                                                  target_size = (20002, 5),
                                                  color_mode = 'grayscale',
                                                  class_mode = 'categorical',
                                                  batch_size = BATCH_SIZE,
...
early_stopping = EarlyStopping(monitor = 'val_accuracy', patience = 30, restore_best_weights = True) # 提前结束训练并取得最好的模型
